...
var seasons = [
    new Season(
        ...
        2019,
        [
            new Team(ScoringSystem.twoone, 2019, "Gour", 2, 4, [120.1, 77.6, 128.6, 63.5, 95.3, 89.4]),
            new Team(ScoringSystem.twoone, 2019, "AK", 3, 3, [86.7, 132.8, 88.7, 185.1, 113.1, 103.2]),
            new Team(ScoringSystem.twoone, 2019, "Kevin", 3, 3, [102, 69, 119.3, 60.2, 77.1, 78.2]),
            new Team(ScoringSystem.twoone, 2019, "Palko", 4, 2, [109.1, 98, 88.2, 124.3, 107.7, 84.4]),
            new Team(ScoringSystem.twoone, 2019, "Tipples", 1, 5, [104, 99.1, 110.9, 73.9, 116.8, 78.2]),
            new Team(ScoringSystem.twoone, 2019, "Codes", 2, 4, [93.5, 86.9, 80.5, 84.8, 84.9, 80.9]),
            new Team(ScoringSystem.twoone, 2019, "Tdub", 3, 3, [76.4, 107.7, 113.6, 100.7, 101.5, 52.5]),
            new Team(ScoringSystem.twoone, 2019, "Spolt", 5, 1, [122.9, 89.5, 107, 97.8, 178.5, 118.5]),
            new Team(ScoringSystem.twoone, 2019, "BJ", 3, 3, [92.6, 77.4, 132, 65.3, 132.3, 159]),
            new Team(ScoringSystem.twoone, 2019, "Lomo", 4, 2, [130.9, 127.7, 82.7, 90.7, 124.7, 92]),
        ]
    ),
    new Season(
        ScoringSystem.twoone,
