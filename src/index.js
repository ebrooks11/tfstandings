...
var seasons = [
    new Season(
        ...
        2018,
        [
            new Team(ScoringSystem.twoone, 2018, "Spencer Gourley", 1, 1, [140.8, 93.8]),
            new Team(ScoringSystem.twoone, 2018, "Amir Kaikhah", 1, 1, [98, 119]),
            new Team(ScoringSystem.twoone, 2018, "Evan Brooks", 1, 1, [142.1, 103.5]),
            new Team(ScoringSystem.twoone, 2018, "David Palko", 2, 0, [92.5, 149.6]),
            new Team(ScoringSystem.twoone, 2018, "Jack Lee", 1, 1, [71.9, 116.6]),
            new Team(ScoringSystem.twoone, 2018, "Cody Dorsett", 0, 2, [66.3, 88]),
            new Team(ScoringSystem.twoone, 2018, "Travis Walsh", 2, 0, [96.2, 97.2]),
            new Team(ScoringSystem.twoone, 2018, "Spencer Sobolik", 0, 2, [128.9, 98.7]),
            new Team(ScoringSystem.twoone, 2018, "Josh Green", 1, 1, [124.1, 80.9]),
            new Team(ScoringSystem.twoone, 2018, "Anthony Palomo", 1, 1, [80.7, 91]),
        ]
    ),
    new Season(
