...
var seasons = [
    new Season(
        ...
        2021,
        [
            new Team(ScoringSystem.twoone, 2021, "Gour", 2, 1, [100.2, 114.36, 104.28]),
            new Team(ScoringSystem.twoone, 2021, "AK", 0, 3, [72.9, 79.16, 95.62]),
            new Team(ScoringSystem.twoone, 2021, "Kev & Eazy", 1, 2, [103.36, 99.12, 129.58]),
            new Team(ScoringSystem.twoone, 2021, "Palko", 1, 2, [60.46, 134, 97.94]),
            new Team(ScoringSystem.twoone, 2021, "Tipples", 3, 0, [116.98, 114.42, 100.6]),
            new Team(ScoringSystem.twoone, 2021, "Cruz", 1, 2, [122.24, 61.62, 80.42]),
            new Team(ScoringSystem.twoone, 2021, "Tdub", 2, 1, [112.52, 72.48, 120.02]),
            new Team(ScoringSystem.twoone, 2021, "Spolt", 0, 3, [89.56, 94, 56.54]),
            new Team(ScoringSystem.twoone, 2021, "BJ", 2, 1, [112.56, 105.62, 83.42]),
            new Team(ScoringSystem.twoone, 2021, "Ram", 3, 0, [103.36, 107, 105.34]),
        ]
    ),
    new Season(
        ScoringSystem.twoone,
