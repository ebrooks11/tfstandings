...
var seasons = [
    new Season(
        ...
        2021,
        [
            new Team(ScoringSystem.twoone, 2021, "Gour", 3, 1, [100.2, 114.36, 104.28, 134.84]),
            new Team(ScoringSystem.twoone, 2021, "AK", 0, 4, [72.9, 79.16, 95.62, 79.32]),
            new Team(ScoringSystem.twoone, 2021, "Kev & Eazy", 1, 3, [103.36, 99.12, 129.58, 76.26]),
            new Team(ScoringSystem.twoone, 2021, "Palko", 2, 2, [60.46, 134, 97.94, 119.22]),
            new Team(ScoringSystem.twoone, 2021, "Tipples", 4, 0, [116.98, 114.42, 100.6, 119.92]),
            new Team(ScoringSystem.twoone, 2021, "Cruz", 2, 2, [122.24, 61.62, 80.42, 95]),
            new Team(ScoringSystem.twoone, 2021, "Tdub", 2, 2, [112.52, 72.48, 120.02, 89.22]),
            new Team(ScoringSystem.twoone, 2021, "Spolt", 0, 4, [89.56, 94, 56.54, 76.64]),
            new Team(ScoringSystem.twoone, 2021, "BJ", 2, 2, [112.56, 105.62, 83.42, 68.66]),
            new Team(ScoringSystem.twoone, 2021, "Ram", 4, 0, [103.36, 107, 105.34, 100.52]),
        ]
    ),
    new Season(
        ScoringSystem.twoone,
