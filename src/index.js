...
var seasons = [
	new Season(
        ...
        2020,
        [
            new Team(ScoringSystem.twoone, 2019, "Gour", 2, 0, [132.44, 131.78]),
            new Team(ScoringSystem.twoone, 2019, "AK", 0, 2, [111.02, 81.78]),
            new Team(ScoringSystem.twoone, 2019, "Kev & Eazy", 1, 1, [109.4, 91.06]),
            new Team(ScoringSystem.twoone, 2019, "Palko", 0, 2, [91, 96.58]),
            new Team(ScoringSystem.twoone, 2019, "Tipples", 2, 0, [82.08, 138.22]),
            new Team(ScoringSystem.twoone, 2019, "Codes", 0, 2, [83.1, 84.12]),
            new Team(ScoringSystem.twoone, 2019, "Tdub", 2, 0, [134.16, 122.84]),
            new Team(ScoringSystem.twoone, 2019, "Spolt", 1, 1, [99.5, 84.08]),
            new Team(ScoringSystem.twoone, 2019, "BJ", 1, 1, [102.74, 87.5]),
            new Team(ScoringSystem.twoone, 2019, "Lomo", 1, 1, [51.66, 97.24]),
        ]
    ),
    new Season(
        ScoringSystem.twoone,
