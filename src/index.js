...
var seasons = [
	new Season(
        ...
        2020,
        [
            new Team(ScoringSystem.twoone, 2020, "Gour", 6, 1, [132.44, 131.78, 118.4, 105.74, 163.8, 65.2, 93.9]),
            new Team(ScoringSystem.twoone, 2020, "AK", 2, 5, [111.02, 81.78, 105.64, 69.12, 68.02, 130.38, 128.72]),
            new Team(ScoringSystem.twoone, 2020, "Kev & Eazy", 4, 3, [109.4, 91.06, 92.58, 78.42, 71.5, 140.72, 117.7]),
            new Team(ScoringSystem.twoone, 2020, "Palko", 1, 6, [91, 96.58, 94.44, 73.84, 82.7, 97.44, 88.4]),
            new Team(ScoringSystem.twoone, 2020, "Tipples", 4, 3, [82.08, 138.22, 92.8, 134.4, 79.18, 64, 54,42]),
            new Team(ScoringSystem.twoone, 2020, "Codes", 1, 6, [83.1, 84.12, 85.82, 79.5, 67.86, 151.64, 99.72]),
            new Team(ScoringSystem.twoone, 2020, "Tdub", 3, 4, [134.16, 122.84, 110.68, 96.14, 117.46, 66.88, 143.22]),
            new Team(ScoringSystem.twoone, 2020, "Spolt", 5, 2, [99.5, 84.08, 101.48, 106.96, 93.92, 67.14, 117.76]),
            new Team(ScoringSystem.twoone, 2020, "BJ", 5, 2, [102.74, 87.5, 127.58, 136.38, 105.84, 76.72, 71.3]),
            new Team(ScoringSystem.twoone, 2020, "Lomo", 4, 3, [51.66, 97.24, 82.1, 122.2, 83.94, 71.14, 113.58]),
        ]
    ),
    new Season(
        ScoringSystem.twoone,
