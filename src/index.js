...
var seasons = [
    new Season(
        ...
        2021,
        [
            new Team(ScoringSystem.twoone, 2021, "Gour", 0, 0, []),
            new Team(ScoringSystem.twoone, 2021, "AK", 0, 0, []),
            new Team(ScoringSystem.twoone, 2021, "Kev & Eazy", 0, 0, []),
            new Team(ScoringSystem.twoone, 2021, "Palko", 0, 0, []),
            new Team(ScoringSystem.twoone, 2021, "Tipples", 0, 0, []),
            new Team(ScoringSystem.twoone, 2021, "Cruz", 0, 0, []),
            new Team(ScoringSystem.twoone, 2021, "Tdub", 0, 0, []),
            new Team(ScoringSystem.twoone, 2021, "Spolt", 0, 0, []),
            new Team(ScoringSystem.twoone, 2021, "BJ", 0, 0, []),
            new Team(ScoringSystem.twoone, 2021, "Ram", 0, 0, []),
        ]
    ),
    new Season(
        ScoringSystem.twoone,
