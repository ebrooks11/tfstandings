...
var seasons = [
    new Season(
        ...
        2021,
        [
            new Team(ScoringSystem.twoone, 2021, "Gour", 4, 2, [100.2, 114.36, 104.28, 134.84, 116.08, 124.78]),
            new Team(ScoringSystem.twoone, 2021, "AK", 2, 4, [72.9, 79.16, 95.62, 79.32, 151.4, 142.12]),
            new Team(ScoringSystem.twoone, 2021, "Kev & Eazy", 2, 4, [103.36, 99.12, 129.58, 76.26, 121.44, 96.18]),
            new Team(ScoringSystem.twoone, 2021, "Palko", 4, 2, [60.46, 134, 97.94, 119.22, 142.96, 107.3]),
            new Team(ScoringSystem.twoone, 2021, "Tipples", 5, 1, [116.98, 114.42, 100.6, 119.92, 136.18, 98.38]),
            new Team(ScoringSystem.twoone, 2021, "Cruz", 3, 3, [122.24, 61.62, 80.42, 95, 118.8, 95.94]),
            new Team(ScoringSystem.twoone, 2021, "Tdub", 3, 3, [112.52, 72.48, 120.02, 89.22, 104.78, 97.9]),
            new Team(ScoringSystem.twoone, 2021, "Spolt", 0, 6, [89.56, 94, 56.54, 76.64, 76.92, 91.56]),
            new Team(ScoringSystem.twoone, 2021, "BJ", 2, 4, [112.56, 105.62, 83.42, 68.66, 65.42, 53.7]),
            new Team(ScoringSystem.twoone, 2021, "Ram", 5, 1, [103.36, 107, 105.34, 100.52, 117.26, 106.56]),
        ]
    ),
    new Season(
        ScoringSystem.twoone,
