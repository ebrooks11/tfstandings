...
var seasons = [
	new Season(
        ...
        2020,
        [
            new Team(ScoringSystem.twoone, 2020, "Gour", 7, 4, [132.44, 131.78, 118.4, 105.74, 163.8, 65.2, 93.9, 103.04, 87.48, 66.42, 108.62]),
            new Team(ScoringSystem.twoone, 2020, "AK", 5, 6, [111.02, 81.78, 105.64, 69.12, 68.02, 130.38, 128.72, 76.06, 89.14, 84.26, 110.56]),
            new Team(ScoringSystem.twoone, 2020, "Kev & Eazy", 6, 5, [109.4, 91.06, 92.58, 78.42, 71.5, 140.72, 117.7, 58.24, 105.72, 95.4, 109.28]),
            new Team(ScoringSystem.twoone, 2020, "Palko", 2, 9, [91, 96.58, 94.44, 73.84, 82.7, 97.44, 88.4, 93.82, 52.9, 92.16, 94.54]),
            new Team(ScoringSystem.twoone, 2020, "Tipples", 4, 7, [82.08, 138.22, 92.8, 134.4, 79.18, 64, 54.42, 56.44, 84.1, 62, 90.74]),
            new Team(ScoringSystem.twoone, 2020, "Codes", 3, 8, [83.1, 84.12, 85.82, 79.5, 67.86, 151.64, 99.72, 62.24, 90.26, 81.08, 58.2]),
            new Team(ScoringSystem.twoone, 2020, "Tdub", 6, 5, [134.16, 122.84, 110.68, 96.14, 117.46, 66.88, 143.22, 68.08, 114.34, 121.02, 104.78]),
            new Team(ScoringSystem.twoone, 2020, "Spolt", 8, 3, [99.5, 84.08, 101.48, 106.96, 93.92, 67.14, 117.76, 166.06, 115.46, 98.74, 114.8]),
            new Team(ScoringSystem.twoone, 2020, "BJ", 8, 3, [102.74, 87.5, 127.58, 136.38, 105.84, 76.72, 71.3, 114.88, 84.14, 90.54, 78.48]),
            new Team(ScoringSystem.twoone, 2020, "Lomo", 6, 5, [51.66, 97.24, 82.1, 122.2, 83.94, 71.14, 113.58, 79.92, 64.84, 93.28, 76.44]),
        ]
    ),
    new Season(
        ScoringSystem.twoone,
