...
var seasons = [
    new Season(
        ...
        2019,
        [
            new Team(ScoringSystem.twoone, 2019, "Gour", 1, 1, [120.1, 77.6]),
            new Team(ScoringSystem.twoone, 2019, "AK", 1, 1, [86.7, 132.8]),
            new Team(ScoringSystem.twoone, 2019, "Kevin", 1, 1, [102, 69]),
            new Team(ScoringSystem.twoone, 2019, "Palko", 1, 1, [109.1, 98]),
            new Team(ScoringSystem.twoone, 2019, "Tipples", 0, 2, [104, 99.1]),
            new Team(ScoringSystem.twoone, 2019, "Codes", 1, 1, [93.5, 86.9]),
            new Team(ScoringSystem.twoone, 2019, "Tdub", 1, 1, [76.4, 107.7]),
            new Team(ScoringSystem.twoone, 2019, "Spolt", 1, 1, [122.9, 89.5]),
            new Team(ScoringSystem.twoone, 2019, "BJ", 1, 1, [92.6, 77.4]),
            new Team(ScoringSystem.twoone, 2019, "Lomo", 2, 0, [130.9, 127.7]),
        ]
    ),
    new Season(
        ScoringSystem.twoone,
