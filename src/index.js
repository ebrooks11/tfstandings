...
var seasons = [
    new Season(
        ...
        2021,
        [
            new Team(ScoringSystem.twoone, 2021, "Gour", 3, 2, [100.2, 114.36, 104.28, 134.84, 116.08]),
            new Team(ScoringSystem.twoone, 2021, "AK", 1, 4, [72.9, 79.16, 95.62, 79.32, 151.4]),
            new Team(ScoringSystem.twoone, 2021, "Kev & Eazy", 2, 3, [103.36, 99.12, 129.58, 76.26, 121.44]),
            new Team(ScoringSystem.twoone, 2021, "Palko", 3, 2, [60.46, 134, 97.94, 119.22, 142.96]),
            new Team(ScoringSystem.twoone, 2021, "Tipples", 5, 0, [116.98, 114.42, 100.6, 119.92, 136.18]),
            new Team(ScoringSystem.twoone, 2021, "Cruz", 3, 2, [122.24, 61.62, 80.42, 95, 118.8]),
            new Team(ScoringSystem.twoone, 2021, "Tdub", 2, 3, [112.52, 72.48, 120.02, 89.22, 104.78]),
            new Team(ScoringSystem.twoone, 2021, "Spolt", 0, 5, [89.56, 94, 56.54, 76.64, 76.92]),
            new Team(ScoringSystem.twoone, 2021, "BJ", 2, 3, [112.56, 105.62, 83.42, 68.66, 65.42]),
            new Team(ScoringSystem.twoone, 2021, "Ram", 4, 1, [103.36, 107, 105.34, 100.52, 117.26]),
        ]
    ),
    new Season(
        ScoringSystem.twoone,
