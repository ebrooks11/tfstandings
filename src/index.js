...
var seasons = [
	new Season(
        ...
        2020,
        [
            new Team(ScoringSystem.twoone, 2020, "Gour", 5, 1, [132.44, 131.78, 118.4, 105.74, 163.8, 65.2]),
            new Team(ScoringSystem.twoone, 2020, "AK", 1, 5, [111.02, 81.78, 105.64, 69.12, 68.02, 130.38]),
            new Team(ScoringSystem.twoone, 2020, "Kev & Eazy", 3, 3, [109.4, 91.06, 92.58, 78.42, 71.5, 140.72]),
            new Team(ScoringSystem.twoone, 2020, "Palko", 1, 5, [91, 96.58, 94.44, 73.84, 82.7, 97.44]),
            new Team(ScoringSystem.twoone, 2020, "Tipples", 4, 2, [82.08, 138.22, 92.8, 134.4, 79.18, 64]),
            new Team(ScoringSystem.twoone, 2020, "Codes", 1, 5, [83.1, 84.12, 85.82, 79.5, 67.86, 151.64]),
            new Team(ScoringSystem.twoone, 2020, "Tdub", 2, 4, [134.16, 122.84, 110.68, 96.14, 117.46, 66.88]),
            new Team(ScoringSystem.twoone, 2020, "Spolt", 4, 2, [99.5, 84.08, 101.48, 106.96, 93.92, 67.14]),
            new Team(ScoringSystem.twoone, 2020, "BJ", 5, 1, [102.74, 87.5, 127.58, 136.38, 105.84, 76.72]),
            new Team(ScoringSystem.twoone, 2020, "Lomo", 4, 2, [51.66, 97.24, 82.1, 122.2, 83.94, 71.14]),
        ]
    ),
    new Season(
        ScoringSystem.twoone,
