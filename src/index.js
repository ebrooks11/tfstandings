...
var seasons = [
	new Season(
        ...
        2020,
        [
            new Team(ScoringSystem.twoone, 2020, "Gour", 7, 3, [132.44, 131.78, 118.4, 105.74, 163.8, 65.2, 93.9, 103.04, 87.48, 66.42]),
            new Team(ScoringSystem.twoone, 2020, "AK", 4, 6, [111.02, 81.78, 105.64, 69.12, 68.02, 130.38, 128.72, 76.06, 89.14, 84.26]),
            new Team(ScoringSystem.twoone, 2020, "Kev & Eazy", 5, 5, [109.4, 91.06, 92.58, 78.42, 71.5, 140.72, 117.7, 58.24, 105.72, 95.4]),
            new Team(ScoringSystem.twoone, 2020, "Palko", 1, 9, [91, 96.58, 94.44, 73.84, 82.7, 97.44, 88.4, 93.82, 52.9, 92.16]),
            new Team(ScoringSystem.twoone, 2020, "Tipples", 4, 6, [82.08, 138.22, 92.8, 134.4, 79.18, 64, 54.42, 56.44, 84.1, 62]),
            new Team(ScoringSystem.twoone, 2020, "Codes", 3, 7, [83.1, 84.12, 85.82, 79.5, 67.86, 151.64, 99.72, 62.24, 90.26, 81.08]),
            new Team(ScoringSystem.twoone, 2020, "Tdub", 5, 5, [134.16, 122.84, 110.68, 96.14, 117.46, 66.88, 143.22, 68.08, 114.34, 121.02]),
            new Team(ScoringSystem.twoone, 2020, "Spolt", 7, 3, [99.5, 84.08, 101.48, 106.96, 93.92, 67.14, 117.76, 166.06, 115.46, 98.74]),
            new Team(ScoringSystem.twoone, 2020, "BJ", 8, 2, [102.74, 87.5, 127.58, 136.38, 105.84, 76.72, 71.3, 114.88, 84.14, 90.54]),
            new Team(ScoringSystem.twoone, 2020, "Lomo", 6, 4, [51.66, 97.24, 82.1, 122.2, 83.94, 71.14, 113.58, 79.92, 64.84, 93.28]),
        ]
    ),
    new Season(
        ScoringSystem.twoone,
