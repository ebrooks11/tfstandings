...
var seasons = [
    new Season(
        ...
        2019,
        [
            new Team(ScoringSystem.twoone, 2019, "Gour", 2, 1, [120.1, 77.6, 128.6]),
            new Team(ScoringSystem.twoone, 2019, "AK", 1, 2, [86.7, 132.8, 88.7]),
            new Team(ScoringSystem.twoone, 2019, "Kevin", 2, 1, [102, 69, 119.3]),
            new Team(ScoringSystem.twoone, 2019, "Palko", 2, 1, [109.1, 98, 88.2]),
            new Team(ScoringSystem.twoone, 2019, "Tipples", 0, 3, [104, 99.1, 110.9]),
            new Team(ScoringSystem.twoone, 2019, "Codes", 1, 2, [93.5, 86.9, 80.5]),
            new Team(ScoringSystem.twoone, 2019, "Tdub", 1, 2, [76.4, 107.7, 113.6]),
            new Team(ScoringSystem.twoone, 2019, "Spolt", 2, 1, [122.9, 89.5, 107]),
            new Team(ScoringSystem.twoone, 2019, "BJ", 2, 1, [92.6, 77.4, 132]),
            new Team(ScoringSystem.twoone, 2019, "Lomo", 2, 1, [130.9, 127.7, 82.7]),
        ]
    ),
    new Season(
        ScoringSystem.twoone,
