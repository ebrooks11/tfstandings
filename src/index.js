...
var seasons = [
	new Season(
        ...
        [
            ...
            new Team(ScoringSystem.twoone, 2020, "Tipples", 4, 4, [82.08, 138.22, 92.8, 134.4, 79.18, 64, 54,42, 56.44]),
            new Team(ScoringSystem.twoone, 2020, "Codes", 2, 6, [83.1, 84.12, 85.82, 79.5, 67.86, 151.64, 99.72, 62.24]),
            new Team(ScoringSystem.twoone, 2020, "Tdub", 3, 5, [134.16, 122.84, 110.68, 96.14, 117.46, 66.88, 143.22, 68.08]),
            new Team(ScoringSystem.twoone, 2020, "Spolt", 6, 2, [99.5, 84.08, 101.48, 106.96, 93.92, 67.14, 117.76, 166.06]),
            new Team(ScoringSystem.twoone, 2020, "BJ", 6, 2, [102.74, 87.5, 127.58, 136.38, 105.84, 76.72, 71.3, 114.88]),
            new Team(ScoringSystem.twoone, 2020, "Lomo", 5, 3, [51.66, 97.24, 82.1, 122.2, 83.94, 71.14, 113.58, 79.92]),
        ]
    ),
    new Season(
        ScoringSystem.twoone,
