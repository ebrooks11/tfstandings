...
var seasons = [
    new Season(
        ...
        2018,
        [
            new Team(ScoringSystem.twoone, 2018, "Spencer Gourley", 2, 2, [140.8, 93.8, 120.4, 107.9]),
            new Team(ScoringSystem.twoone, 2018, "Amir Kaikhah", 2, 2, [98, 119, 92, 103]),
            new Team(ScoringSystem.twoone, 2018, "Evan Brooks", 2, 2, [142.1, 103.5, 97.1, 87.3]),
            new Team(ScoringSystem.twoone, 2018, "David Palko", 3, 1, [92.5, 149.6, 87.3, 156]),
            new Team(ScoringSystem.twoone, 2018, "Jack Lee", 2, 2, [71.9, 116.6, 74.7, 107.2]),
