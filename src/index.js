...
var seasons = [
    new Season(
        ...
        2019,
        [
            new Team(ScoringSystem.twoone, 2019, "Gour", 2, 2, [120.1, 77.6, 128.6, 63.5]),
            new Team(ScoringSystem.twoone, 2019, "AK", 2, 2, [86.7, 132.8, 88.7, 185.1]),
            new Team(ScoringSystem.twoone, 2019, "Kevin", 2, 2, [102, 69, 119.3, 60.2]),
            new Team(ScoringSystem.twoone, 2019, "Palko", 3, 1, [109.1, 98, 88.2, 124.3]),
            new Team(ScoringSystem.twoone, 2019, "Tipples", 0, 4, [104, 99.1, 110.9, 73.9]),
            new Team(ScoringSystem.twoone, 2019, "Codes", 2, 2, [93.5, 86.9, 80.5, 84.8]),
            new Team(ScoringSystem.twoone, 2019, "Tdub", 2, 2, [76.4, 107.7, 113.6, 100.7]),
            new Team(ScoringSystem.twoone, 2019, "Spolt", 3, 1, [122.9, 89.5, 107, 97.8]),
            new Team(ScoringSystem.twoone, 2019, "BJ", 2, 2, [92.6, 77.4, 132, 65.3]),
            new Team(ScoringSystem.twoone, 2019, "Lomo", 2, 2, [130.9, 127.7, 82.7, 90.7]),
        ]
    ),
    new Season(
        ScoringSystem.twoone,
