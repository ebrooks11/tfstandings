...
var seasons = [
    new Season(
        ...
        2018,
        [
            new Team(ScoringSystem.twoone, 2018, "Spencer Gourley", 3, 3, [140.8, 93.8, 120.4, 107.9, 96.8, 112.1]),
            new Team(ScoringSystem.twoone, 2018, "Amir Kaikhah", 4, 2, [98, 119, 92, 103, 98.4, 111.3]),
            new Team(ScoringSystem.twoone, 2018, "Evan Brooks", 3, 3, [142.1, 103.5, 97.1, 87.3, 115, 125.8]),
            new Team(ScoringSystem.twoone, 2018, "David Palko", 3, 3, [92.5, 149.6, 87.3, 156, 81.6, 114.3]),
            new Team(ScoringSystem.twoone, 2018, "Jack Lee", 3, 3, [71.9, 116.6, 74.7, 107.2, 119.5, 80.7]),
            new Team(ScoringSystem.twoone, 2018, "Cody Dorsett",3, 3, [66.3, 88, 81.9, 119.1, 92.2, 131.1]),
            new Team(ScoringSystem.twoone, 2018, "Travis Walsh", 4, 2, [96.2, 97.2, 97.4, 90.3, 94.5, 63.9]),
            new Team(ScoringSystem.twoone, 2018, "Spencer Sobolik", 2, 4, [128.9, 98.7, 83.8, 105.9, 98.3, 136.5]),
            new Team(ScoringSystem.twoone, 2018, "BJ", 3, 3, [124.1, 80.9, 114, 111.9, 120.7, 102.4]),
            new Team(ScoringSystem.twoone, 2018, "Anthony Palomo", 2, 4, [80.7, 91, 64.1, 97, 112.7, 91.2]),
        ]
    ),
    new Season(
