...
var seasons = [
    ...
    new Season(
        2017,
        [
            new Team(2017, "Spencer Gourley", 9, 4, [85.4, 106, 107.6, 119, 69.2, 87.5, 119.5, 122.2, 0, 80.6, 115.3, 127.6, 117.9]),
            new Team(2017, "Spencer Sobolik", 9, 4, [103.2, 101.5, 112.1, 84.2, 93.8, 111.6, 91.6, 84.7, 79.3, 98.8, 76.5, 66, 86.5]),
            new Team(2017, "Amir Kaikhah", 8, 5, [77, 86.1, 103.7, 69.6, 92.8, 90.7, 87.8, 97.3, 106.2, 82.3, 102, 128.7, 101.1]),
            new Team(2017, "Josh Green", 7, 6, [94.7, 81.9, 66.8, 108.9, 100.6, 65.3, 76.8, 108.7, 71.9, 103.6, 119.6, 95.7, 108.5]),
            new Team(2017, "Evan Brooks", 6, 7, [97, 69.8, 94.9, 85.6, 97.2, 119.4, 67.9, 95, 81.7, 70.3, 115.9, 108.4, 103.8]),
            new Team(2017, "Anthony Palomo", 6, 7, [75.7, 78.9, 101.5, 104.6, 75.6, 114, 115.4, 94.3, 117.3, 103.7, 54.4, 101.7, 76.5]),
            new Team(2017, "David Palko", 6, 7, [102.8, 116.5, 44.7, 82.7, 102.8, 81.5, 103.2, 102, 82.2, 97.9, 99.9, 91.4, 79.9]),
            new Team(2017, "Jack Lee", 6, 7, [66.2, 80.2, 89.1, 102, 119.9, 129.4, 101, 87.1, 104.5, 79.5, 96.2, 109.4, 94.3]),
            new Team(2017, "Cody Dorsett", 4, 9, [68, 121, 87.8, 96.1, 78.9, 83.3, 61, 90.7, 71.3, 94.8, 53.5, 70.3, 91.1]),
            new Team(2017, "Travis Walsh", 4, 9, [73.4, 94.5, 99.9, 77.8, 64.9, 73, 92.4, 81, 81.4, 56.4, 80, 74.1, 106.2])
        ]
    ),
    new Season(
        2016,
        [
            new Team(2016, "Spencer Gourley", 3, 10, [86.8, 80, 84.7, 122.4, 63.3, 82.8, 108.8, 74.4, 88.8, 77.5, 91.5, 65.1, 96]),
            new Team(2016, "Spencer Sobolik", 7, 6, [122.8, 76.4, 110.6, 82.4, 71.5, 87.7, 119.4, 80, 119.2, 103.1, 117.9, 112.4, 85.8]),
            new Team(2016, "Amir Kaikhah", 6, 7, [107.9, 89.6, 63.7, 102.2, 112.9, 96.5, 67.4, 131.2, 63.3, 85.4, 72, 83.6, 119.5]),
            new Team(2016, "Josh Green", 7, 6, [125.3, 119.2, 75.3, 99.6, 120.4, 117.1, 113.7, 92.8, 65.2, 108.6, 79, 56.6, 106.3]),
            new Team(2016, "Evan Brooks", 7, 6, [87.5, 106.1, 105.5, 112, 84.9, 118.9, 75.4, 101.9, 119.7, 87.4, 107.8, 118.6, 98.1]),
            new Team(2016, "Anthony Palomo", 9, 4, [118.8, 78.5, 103.3, 88.8, 120.1, 97.4, 61.4, 114.3, 80.1, 139.7, 94.4, 150.1, 108.5]),
            new Team(2016, "David Palko", 6, 7, [100, 112.4, 124.7, 90.7, 111.3, 95.6, 107.9, 85.9, 89.6, 101, 77.1, 95.3, 100.5]),
            new Team(2016, "Jack Lee", 7, 6, [75, 102.5, 122.5, 79.7, 99.2, 112.5, 95.1, 75.2, 91.6, 103.9, 88.4, 82.4, 75.7]),
            new Team(2016, "Cody Dorsett", 6, 7, [91.2, 59.6, 95.7, 78.1, 97.8, 56.6, 112.8, 93.8, 107.8, 115.7, 83, 121.8, 50.7]),
            new Team(2016, "Travis Walsh", 7, 6, [112.9, 92.1, 83.6, 67.9, 92.8, 92.4, 73.5, 86.1, 143.6, 101.9, 91.9, 106.5, 108.9])
        ]
    )
];
