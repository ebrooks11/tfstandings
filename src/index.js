...
var seasons = [
    new Season(
        ...
        [
            ...
            new Team(ScoringSystem.twoone, 2019, "Codes", 2, 5, [93.5, 86.9, 80.5, 84.8, 84.9, 80.9, 52]),
            new Team(ScoringSystem.twoone, 2019, "Tdub", 4, 3, [76.4, 107.7, 113.6, 100.7, 101.5, 52.5, 127.5]),
            new Team(ScoringSystem.twoone, 2019, "Spolt", 6, 1, [122.9, 89.5, 107, 97.8, 178.5, 118.5, 97.9]),
            new Team(ScoringSystem.twoone, 2019, "BJ", 3, 4, [92.6, 77.4, 132, 65.3, 132.3, 159, 71.6]),
            new Team(ScoringSystem.twoone, 2019, "Lomo", 5, 2, [130.9, 127.7, 82.7, 90.7, 124.7, 92, 126.1]),
        ]
    ),
    new Season(
        ScoringSystem.twoone,
