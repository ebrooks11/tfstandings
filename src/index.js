...
var seasons = [
	new Season(
        ...
        2020,
        [
            new Team(ScoringSystem.twoone, 2019, "Gour", 4, 0, [132.44, 131.78, 118.4, 105.74]),
            new Team(ScoringSystem.twoone, 2019, "AK", 1, 3, [111.02, 81.78, 105.64, 69.12]),
            new Team(ScoringSystem.twoone, 2019, "Kev & Eazy", 1, 3, [109.4, 91.06, 92.58, 78.42]),
            new Team(ScoringSystem.twoone, 2019, "Palko", 0, 4, [91, 96.58, 94.44, 73.84]),
            new Team(ScoringSystem.twoone, 2019, "Tipples", 4, 0, [82.08, 138.22, 92.8, 134.4]),
            new Team(ScoringSystem.twoone, 2019, "Codes", 0, 4, [83.1, 84.12, 85.82, 79.5]),
            new Team(ScoringSystem.twoone, 2019, "Tdub", 2, 2, [134.16, 122.84, 110.68, 96.14]),
            new Team(ScoringSystem.twoone, 2019, "Spolt", 3, 1, [99.5, 84.08, 101.48, 106.96]),
            new Team(ScoringSystem.twoone, 2019, "BJ", 3, 1, [102.74, 87.5, 127.58, 136.38]),
            new Team(ScoringSystem.twoone, 2019, "Lomo", 2, 2, [51.66, 97.24, 82.1, 122.2]),
        ]
    ),
    new Season(
        ScoringSystem.twoone,
