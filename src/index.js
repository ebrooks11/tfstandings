...
var seasons = [
    new Season(
        ...
        2021,
        [
            new Team(ScoringSystem.twoone, 2021, "Gour", 7, 3, [100.2, 114.36, 104.28, 134.84, 116.08, 124.78, 123.88, 87.68, 125.04, 110.22]),
            new Team(ScoringSystem.twoone, 2021, "AK", 5, 5, [72.9, 79.16, 95.62, 79.32, 151.4, 142.12, 84.9, 112.66, 72.66, 133.64]),
            new Team(ScoringSystem.twoone, 2021, "Kev & Eazy", 3, 7, [103.36, 99.12, 129.58, 76.26, 121.44, 96.18, 84.44, 129.9, 86.08, 65]),
            new Team(ScoringSystem.twoone, 2021, "Palko", 6, 4, [60.46, 134, 97.94, 119.22, 142.96, 107.3, 115.46, 86.06, 82.88, 77.68]),
            new Team(ScoringSystem.twoone, 2021, "Tipples", 6, 4, [116.98, 114.42, 100.6, 119.92, 136.18, 98.38, 105.14, 65, 59.64, 105.4]),
            new Team(ScoringSystem.twoone, 2021, "Cruz", 4, 6, [122.24, 61.62, 80.42, 95, 118.8, 95.94, 119.76, 126, 65.36, 70.92]),
            new Team(ScoringSystem.twoone, 2021, "Tdub", 7, 3, [112.52, 72.48, 120.02, 89.22, 104.78, 97.9, 96.52, 87.36, 86.48, 95.34]),
            new Team(ScoringSystem.twoone, 2021, "Spolt", 2, 8, [89.56, 94, 56.54, 76.64, 76.92, 91.56, 96.74, 71.82, 84.56, 103.5]),
            new Team(ScoringSystem.twoone, 2021, "BJ", 4, 6, [112.56, 105.62, 83.42, 68.66, 65.42, 53.7, 80.54, 94.92, 88.18, 74.92]),
            new Team(ScoringSystem.twoone, 2021, "Ram", 6, 4, [103.36, 107, 105.34, 100.52, 117.26, 106.56, 95.84, 46.36, 84.2, 53.78]),
        ]
    ),
    new Season(
        ScoringSystem.twoone,
