...
var seasons = [
    new Season(
        ...
        2021,
        [
            new Team(ScoringSystem.twoone, 2021, "Gour", 0, 1, [100.2]),
            new Team(ScoringSystem.twoone, 2021, "AK", 0, 1, [72.9]),
            new Team(ScoringSystem.twoone, 2021, "Kev & Eazy", 0, 1, [103.36]),
            new Team(ScoringSystem.twoone, 2021, "Palko", 0, 1, [60.46]),
            new Team(ScoringSystem.twoone, 2021, "Tipples", 1, 0, [116.98]),
            new Team(ScoringSystem.twoone, 2021, "Cruz", 1, 0, [122.24]),
            new Team(ScoringSystem.twoone, 2021, "Tdub", 1, 0, [112.52]),
            new Team(ScoringSystem.twoone, 2021, "Spolt", 0, 1, [89.56]),
            new Team(ScoringSystem.twoone, 2021, "BJ", 1, 0, [112.56]),
            new Team(ScoringSystem.twoone, 2021, "Ram", 1, 0, [103.36]),
        ]
    ),
    new Season(
        ScoringSystem.twoone,
