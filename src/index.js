...
var seasons = [
    new Season(
        ...
        2018,
        [
            new Team(ScoringSystem.twoone, 2018, "Spencer Gourley", 1, 0, [140.8]),
            new Team(ScoringSystem.twoone, 2018, "Amir Kaikhah", 0, 1, [98]),
            new Team(ScoringSystem.twoone, 2018, "Evan Brooks", 1, 0, [142.1]),
            new Team(ScoringSystem.twoone, 2018, "David Palko", 1, 0, [92.5]),
            new Team(ScoringSystem.twoone, 2018, "Jack Lee", 0, 1, [71.9]),
            new Team(ScoringSystem.twoone, 2018, "Cody Dorsett", 0, 1, [66.3]),
            new Team(ScoringSystem.twoone, 2018, "Travis Walsh", 1, 0, [96.2]),
            new Team(ScoringSystem.twoone, 2018, "Spencer Sobolik", 0, 1, [128.9]),
            new Team(ScoringSystem.twoone, 2018, "Josh Green", 1, 0, [124.1]),
            new Team(ScoringSystem.twoone, 2018, "Anthony Palomo", 0, 1, [80.7]),
        ]
    ),
    new Season(
