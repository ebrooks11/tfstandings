...
var seasons = [
    new Season(
        ...
        2018,
        [
            new Team(ScoringSystem.twoone, 2018, "Gour", 5, 6, [140.8, 93.8, 120.4, 107.9, 96.8, 112.1, 113.9, 105.4, 87, 78.7, 119.7]),
            new Team(ScoringSystem.twoone, 2018, "AK", 8, 3, [98, 119, 92, 103, 98.4, 111.3, 107.1, 135.1, 105.1, 104.3, 120.7]),
            new Team(ScoringSystem.twoone, 2018, "Kevin", 7, 4, [142.1, 103.5, 97.1, 87.3, 115, 125.8, 123.2, 113.9, 116.8, 108.9, 140.3]),
            new Team(ScoringSystem.twoone, 2018, "Palko", 4, 7, [92.5, 149.6, 87.3, 156, 81.6, 114.3, 92.6, 90.2, 163.5, 102.7, 115]),
            new Team(ScoringSystem.twoone, 2018, "Tipples", 6, 5, [71.9, 116.6, 74.7, 107.2, 119.5, 80.7, 84.9, 124.9, 92.9, 106.1, 95.5]),
            new Team(ScoringSystem.twoone, 2018, "Codes",4, 7, [66.3, 88, 81.9, 119.1, 92.2, 131.1, 122.4, 71.1, 109.1, 84.5, 85.2]),
            new Team(ScoringSystem.twoone, 2018, "Tdub", 8, 3, [96.2, 97.2, 97.4, 90.3, 94.5, 63.9, 116.1, 137, 43.3, 155, 102.7]),
            new Team(ScoringSystem.twoone, 2018, "Spolt", 3, 8, [128.9, 98.7, 83.8, 105.9, 98.3, 136.5, 83.4, 82.1, 88.1, 132.3, 104.6]),
            new Team(ScoringSystem.twoone, 2018, "BJ", 6, 5, [124.1, 80.9, 114, 111.9, 120.7, 102.4, 111, 105.3, 127.9, 95.7, 117.7]),
            new Team(ScoringSystem.twoone, 2018, "Lomo", 4, 7, [80.7, 91, 64.1, 97, 112.7, 91.2, 83.6, 73, 90.1, 115.6, 108]),
        ]
    ),
    new Season(
