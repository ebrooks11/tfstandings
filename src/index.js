...
var seasons = [
    new Season(
        ...
        2019,
        [
            new Team(ScoringSystem.twoone, 2019, "Gour", 4, 5, [120.1, 77.6, 128.6, 63.5, 95.3, 89.4, 73.5, 91.7, 130.6]),
            new Team(ScoringSystem.twoone, 2019, "AK", 5, 4, [86.7, 132.8, 88.7, 185.1, 113.1, 103.2, 74.4, 138.2, 90.9]),
            new Team(ScoringSystem.twoone, 2019, "Kevin", 5, 4, [102, 69, 119.3, 60.2, 77.1, 78.2, 94.6, 131.4, 77.5]),
            new Team(ScoringSystem.twoone, 2019, "Palko", 5, 4, [109.1, 98, 88.2, 124.3, 107.7, 84.4, 91.4, 93.3, 104.6]),
            new Team(ScoringSystem.twoone, 2019, "Tipples", 1, 8, [104, 99.1, 110.9, 73.9, 116.8, 78.2, 96.2, 77.9, 86.3]),
            new Team(ScoringSystem.twoone, 2019, "Codes", 3, 6, [93.5, 86.9, 80.5, 84.8, 84.9, 80.9, 52, 85.5, 113.1]),
            new Team(ScoringSystem.twoone, 2019, "Tdub", 5, 4, [76.4, 107.7, 113.6, 100.7, 101.5, 52.5, 127.5, 132.3, 82]),
            new Team(ScoringSystem.twoone, 2019, "Spolt", 6, 3, [122.9, 89.5, 107, 97.8, 178.5, 118.5, 97.9, 102.6, 110.6]),
            new Team(ScoringSystem.twoone, 2019, "BJ", 4, 5, [92.6, 77.4, 132, 65.3, 132.3, 159, 71.6, 114.5, 112.9]),
            new Team(ScoringSystem.twoone, 2019, "Lomo", 7, 2, [130.9, 127.7, 82.7, 90.7, 124.7, 92, 126.1, 98.4, 93.1]),
        ]
    ),
    new Season(
        ScoringSystem.twoone,
