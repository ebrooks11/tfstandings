...
var seasons = [
    new Season(
        ...
        2018,
        [
            new Team(ScoringSystem.twoone, 2018, "Spencer Gourley", 2, 1, [140.8, 93.8, 120.4]),
            new Team(ScoringSystem.twoone, 2018, "Amir Kaikhah", 2, 1, [98, 119, 92]),
            new Team(ScoringSystem.twoone, 2018, "Evan Brooks", 2, 1, [142.1, 103.5, 97.1]),
            new Team(ScoringSystem.twoone, 2018, "David Palko", 2, 1, [92.5, 149.6, 87.3]),
            new Team(ScoringSystem.twoone, 2018, "Jack Lee", 1, 2, [71.9, 116.6, 74.7]),
            new Team(ScoringSystem.twoone, 2018, "Cody Dorsett", 1, 2, [66.3, 88, 81.9]),
            new Team(ScoringSystem.twoone, 2018, "Travis Walsh", 3, 0, [96.2, 97.2, 97.4]),
            new Team(ScoringSystem.twoone, 2018, "Spencer Sobolik", 0, 3, [128.9, 98.7, 83.8]),
            new Team(ScoringSystem.twoone, 2018, "Josh Green", 1, 2, [124.1, 80.9, 114]),
            new Team(ScoringSystem.twoone, 2018, "Anthony Palomo", 1, 2, [80.7, 91, 64.1]),
        ]
    ),
    new Season(
