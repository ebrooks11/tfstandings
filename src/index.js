...
var seasons = [
	new Season(
        ...
        2020,
        [
            new Team(ScoringSystem.twoone, 2019, "Gour", 1, 0, [132.44, 131.78, 118.4]),
            new Team(ScoringSystem.twoone, 2019, "AK", 1, 2, [111.02, 81.78, 105.64]),
            new Team(ScoringSystem.twoone, 2019, "Kev & Eazy", 1, 2, [109.4, 91.06, 92.58]),
            new Team(ScoringSystem.twoone, 2019, "Palko", 0, 3, [91, 96.58, 94.44]),
            new Team(ScoringSystem.twoone, 2019, "Tipples", 3, 0, [82.08, 138.22, 92.8]),
            new Team(ScoringSystem.twoone, 2019, "Codes", 0, 3, [83.1, 84.12, 85.82]),
            new Team(ScoringSystem.twoone, 2019, "Tdub", 2, 1, [134.16, 122.84, 110.68]),
            new Team(ScoringSystem.twoone, 2019, "Spolt", 2, 1, [99.5, 84.08, 101.48]),
            new Team(ScoringSystem.twoone, 2019, "BJ", 2, 1, [102.74, 87.5, 127.58]),
            new Team(ScoringSystem.twoone, 2019, "Lomo", 1, 2, [51.66, 97.24, 82.1]),
        ]
    ),
    new Season(
        ScoringSystem.twoone,
