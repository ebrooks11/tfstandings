...
var seasons = [
    new Season(
        ...
        2018,
        [
            new Team(ScoringSystem.twoone, 2018, "Spencer Gourley", 4, 4, [140.8, 93.8, 120.4, 107.9, 96.8, 112.1, 113.9, 105.4]),
            new Team(ScoringSystem.twoone, 2018, "Amir Kaikhah", 5, 3, [98, 119, 92, 103, 98.4, 111.3, 107.1, 135.1]),
            new Team(ScoringSystem.twoone, 2018, "Evan Brooks", 5, 3, [142.1, 103.5, 97.1, 87.3, 115, 125.8, 123.2, 113.9]),
            new Team(ScoringSystem.twoone, 2018, "David Palko", 3, 5, [92.5, 149.6, 87.3, 156, 81.6, 114.3, 92.6, 90.2]),
            new Team(ScoringSystem.twoone, 2018, "Jack Lee", 5, 3, [71.9, 116.6, 74.7, 107.2, 119.5, 80.7, 84.9, 124.9]),
            new Team(ScoringSystem.twoone, 2018, "Cody Dorsett",4, 4, [66.3, 88, 81.9, 119.1, 92.2, 131.1, 122.4, 71.1]),
            new Team(ScoringSystem.twoone, 2018, "Travis Walsh", 6, 2, [96.2, 97.2, 97.4, 90.3, 94.5, 63.9, 116.1, 137]),
            new Team(ScoringSystem.twoone, 2018, "Spencer Sobolik", 2, 6, [128.9, 98.7, 83.8, 105.9, 98.3, 136.5, 83.4, 82.1]),
            new Team(ScoringSystem.twoone, 2018, "BJ", 4, 4, [124.1, 80.9, 114, 111.9, 120.7, 102.4, 111, 105.3]),
            new Team(ScoringSystem.twoone, 2018, "Anthony Palomo", 2, 6, [80.7, 91, 64.1, 97, 112.7, 91.2, 83.6, 73]),
        ]
    ),
    new Season(
